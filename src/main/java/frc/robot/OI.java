...
jB12 = new JoystickButton(jS1, 12);
jB12.whileHeld(new SpinToColor());
jB11 = new JoystickButton(jS1, 11);
jB11.whenPressed(new SpinToCount());
jB10 = new JoystickButton(jS1, 10);
...
jB01.whileHeld(new DoNothing());
        ...
        SmartDashboard.putData("SpinnerDefault", new SpinnerDefault());
        SmartDashboard.putData("ShooterDefault", new ShooterDefault());
        SmartDashboard.putData("PickupDefault", new PickupDefault());
        SmartDashboard.putData("LiftDefault", new LiftDefault());
        SmartDashboard.putData("LightDriveDefault", new LightDriveDefault());
